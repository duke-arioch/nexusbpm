...
public class ParameterLinkedHashMap extends LinkedHashMap<String, Parameter> implements ParameterMap {
  ...
  Parameter requestId = new Parameter(REQUEST_ID_FIELDNAME, ParameterType.STRING, null, true, Parameter.DIRECTION_INPUT);
  Parameter tokenId = new Parameter(TOKEN_ID_FIELDNAME, ParameterType.LONG, null, true, Parameter.DIRECTION_INPUT);
  Parameter instanceId = new Parameter(INSTANCE_ID_FIELDNAME, ParameterType.LONG, null, true, Parameter.DIRECTION_INPUT);
  Parameter nodeName = new Parameter(NODE_NAME_FIELDNAME, ParameterType.STRING, null, true, Parameter.DIRECTION_INPUT);
  Parameter processName = new Parameter(PROCESS_NAME_FIELDNAME, ParameterType.STRING, null, true, Parameter.DIRECTION_INPUT);
  Parameter processVersion = new Parameter(PROCESS_VERSION_FIELDNAME, ParameterType.STRING, null, true, Parameter.DIRECTION_INPUT);
  Parameter transitionName = new Parameter(TRANSITION_NAME_FIELDNAME, ParameterType.STRING, null, true, Parameter.DIRECTION_INPUT);
  Parameter autoSignalling = new Parameter(AUTO_SIGNALLING_FIELDNAME, ParameterType.BOOLEAN, null, true, Parameter.DIRECTION_INPUT);
  ...
  public ParameterMap toInputMap() {
    ParameterMap map = new ParameterLinkedHashMap();
  ...
  public ParameterMap toOutputMap() {
    ParameterMap map = new ParameterLinkedHashMap();
    for (Entry<String, Parameter> entry : this.entrySet()) {
