package com.nexusbpm.common.util;
...
import com.nexusbpm.common.io.interfaces.DataflowStreamProvider;
...
public class GroovyPreprocessor {
    private static final Log LOG = LogFactory.getLog(GroovyPreprocessor.class);
    /**
...
//            Object o = pyObj.__tojava__(Object.class);
        if(value instanceof DataflowStreamProvider) {
            result = ((DataflowStreamProvider) value).getURI().toString();
        } else if(value == null) {
            result = "null";
        } else {
